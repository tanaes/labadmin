...
class TestPMShotgunPool(TestHandlerBase):
    ...
    def test_post(self):
        ...
        exp_cps[15, 19] = 11.54
        exp_conc = np.zeros((16, 24))
        exp_conc[0, :] = [2.57826624e+01, 2.97110911e+02, 4.33465466e+02,
                          4.68813048e+02, 2.68898490e+02, 9.71203928e+00,
                          4.78944005e+02, 5.14321775e+02, 7.04247254e+01,
                          5.88898211e+02, 7.24095301e+02, 2.12545934e+02,
                          1.52158600e+01, 8.48818054e-01, 6.80079336e+00,
                          1.87090612e+01, 1.31289396e-02, 1.16974278e+00,
                          1.54342858e+01, 1.15401072e-01, 6.42390993e+00,
                          1.46832238e+01, 1.66928974e+01, 1.60398251e-03]
        exp_conc[1, :] = [4.85819313e+02, 6.19020960e+02, 9.64307208e+00,
                          3.30631218e+02, 6.46063873e+02, 2.95001065e+02,
                          4.03649420e+02, 7.61133519e+02, 5.52312767e+02,
                          4.92793317e+02, 5.25436167e+02, 1.71633591e+02,
                          3.12308439e+02, 2.05105693e+02, 4.06826142e+01,
                          7.57346000e-01, 0.00000000e+00, 0.00000000e+00,
                          1.43828804e+00, 1.44754270e+01, 0.00000000e+00,
                          0.00000000e+00, 0.00000000e+00, 0.00000000e+00]
        exp_conc[15, 19] = 1.44754270e+01
        ...
        npt.assert_allclose(obs_conc, exp_conc, rtol=1e-05)
